...
final class UserTests: XCTestCase {
    func testUsersCanBeRetrivedFromAPI() throws {
        ...
        let expectedName = "Czesio"
        let expectedUsername = "czesio"
        ...
        _ = try User(name: "FunnyGuy", username: "funnyGuy").save(on: connection).wait()
        ...
        XCTAssertEqual(users[0].name, "Czesio")
        XCTAssertEqual(users[0].username, "czesio")
